...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  layer.masksToBounds = YES;
    ...
    UIButton * btnAppointment = (UIButton *)[cell viewWithTag:601];
    UIButton * btnNav = (UIButton *)[cell viewWithTag:602];
    UIButton * btncall = (UIButton *)[cell viewWithTag:603];
    UIButton * btnmessage = (UIButton *)[cell viewWithTag:604];
    UIButton * btnrating = (UIButton *)[cell viewWithTag:605];
    UIButton * btnHistory = (UIButton *)[cell viewWithTag:606];
